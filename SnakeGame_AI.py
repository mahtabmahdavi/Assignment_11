...
class Snake(arcade.Sprite):
    ...
    def draw(self):
        arcade.draw_rectangle_filled(self.center_x, self.center_y, self.width, self.height, self.color, 45)
...
class Apple(arcade.Sprite):
    def __init__(self):
        ...
        self.snake = Snake()
        temp_x = random.randint(0, SCREEN_WIDTH // 2) * 2
        temp_y = random.randint(0, SCREEN_HEIGHT // 2) * 2
